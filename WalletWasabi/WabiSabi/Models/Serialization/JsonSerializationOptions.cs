		...
		Converters = new List<JsonConverter>()
			{
				...
				new CoinWithOwnershipProofJsonConverter(), // Since CoinWithOwnershipProof is child of Coin, CoinWithOwnershipProofJsonConverter must be before CoinJsonConverter
